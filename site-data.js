window.SITE_DATA = {
  ...
  pages: {
    home: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `
            <div class="timeline">
              <article><span>2023 - Present</span><h3>Assistant Professor</h3><p>NIT Warangal / MNNIT Allahabad</p></article>
      ...
      sections: [
        {
          ...
          body: `
            ...
            <div class="table-wrap"><table><thead><tr><th>Topic</th><th>University</th></tr></thead><tbody>
              <tr><td>EV On-board Chargers</td><td>MNNIT Allahabad</td></tr>
              <tr><td>Wide Bandgap Device Characterization</td><td>MNNIT Allahabad</td></tr>
              <tr><td>Renewable Integration in DC Microgrids</td><td>MNNIT Allahabad</td></tr>
              <tr><td>Wireless Power Transfer Network Control</td><td>GRIET Hyderabad</td></tr>
            </tbody></table></div>`
        },
        {
          kicker: "Memberships",
      ...
      sections: [
        {
          ...
          body: `
            <div class="table-wrap"><table><thead><tr><th>Project</th><th>Agency</th><th>Amount</th></tr></thead><tbody>
              ...
              <tr><td>Energy Efficiency & Hybrid Storage</td><td>AUS, UAE</td><td>₹38.5 Lakhs</td></tr>
      ...
      sections: [
        {
          ...
          body: `
            <div class="paper-list">
              <article><h3>High Gain Non-Isolated Bi-Directional DC-DC Converter</h3><p>Granted Nov 2021. Patent No: 418205.</p></article>
            </div>`
        },
        {
          kicker: "Published",
          ...
          body: `
            <div class="paper-list">
              <article><h3>Energy Re-Circulation Circuit for Device Characterisation</h3><p>Filed at NC State University.</p></article>
              <article><h3>Novel Single-Stage Inverter</h3><p>Indian Patent Published.</p></article>
              <article><h3>Capacitor Clamped Bidirectional DC-DC Converter</h3><p>Indian Patent Published.</p></article>
            </div>`
        }
      ]
    },
    publications: {
      ...
      lead: "605 citations, h-index 14, i10-index 15. Includes 37 conference proceedings.",
      sections: [
        {
          kicker: "Journals",
      ...
      sections: [
        {
          ...
          body: `
            <div class="card-grid">
              <article><h3>LC Impedance Source Converter</h3><p>American University of Sharjah.</p></article>
    ...
    editorial: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: `
            <div class="tag-cloud">
              <span>IEEE TIE</span><span>IEEE JESTPE</span><span>Solar Energy</span><span>IET Power Electronics</span><span>IEEE Access</span>
            </div>`
        }
      ]
    },
