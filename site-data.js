window.SITE_DATA = {
  nav: [
    ...
    { key: "team", label: "Team/Collaborations", href: "team-collaborations.html" },
  ...
  pages: {
    home: {
      ...
      lead: "Assistant Professor, Electrical Engineering Department, NIT Warangal. Researcher in power converters, electric vehicle systems, renewable energy conversion, motor drives, wide band-gap devices, and AI-enabled power electronics.",
      heroImage: true,
      stats: [
        ["10+", "Years of industrial R&D and academic experience"],
        ["605", "Citations"],
        ["14", "h-index"],
        ["15", "i10-index"],
        ["1 + 3", "Granted patent and published disclosures"],
        ["37", "Conference proceedings"]
      ],
      sections: [
        {
          kicker: "Welcome",
          title: "Research shaped by prototypes, controls, and real power hardware.",
          body: `
            <div class="split-copy">
              <p>Dr. Dogga Raveendhra is an Assistant Professor in the Electrical Engineering Department at NIT Warangal. His work spans power electronic converters, electric transportation systems, renewable energy conversion, hybrid energy storage systems, converter modelling, controller implementation, and laboratory validation.</p>
              <p>Before NIT Warangal, his CV records academic, industrial, startup, and international research roles with MNNIT Allahabad, ALTEN GmbH Germany, American University of Sharjah, NC State University's FREEDM Systems Center, Zunik Energies, GRIET Hyderabad, IIT Roorkee, and Graphic Era University.</p>
            </div>`
        },
        {
          ...
          body: `
            <div class="card-grid four">
              <article><h3>Smart Mobility</h3><p>Bidirectional on-board chargers with V2X capabilities, EV power converters, BLDC, PMSM, and SRM drives.</p></article>
              <article><h3>Power Electronics and Devices</h3><p>Novel DC-AC, DC-DC, and AC-DC converter topologies, wide band-gap devices, and power semiconductor characterization.</p></article>
              <article><h3>Embedded Power Electronics</h3><p>DSP and FPGA controlled power converters, inter-converter communications, embedded control, and digital implementation.</p></article>
              <article><h3>Renewable Energy</h3><p>Power conditioning units for solar power conversion, grid integration, DC microgrids, and hybrid energy storage systems.</p></article>
            </div>`
        },
        {
          kicker: "Highlights",
          title: "Selected profile summary from the latest CV",
          body: `
            <ul class="feature-list">
              <li>Excellence in Doctoral Research Award from IIT Roorkee for best Ph.D. work.</li>
              <li>Ph.D. thesis graded A from the Electrical Engineering Department, IIT Roorkee.</li>
              <li>Best Innovation Award by Zunik Energies in 2019.</li>
              <li>Research travel and collaborations across USA, Germany, Malaysia, and UAE.</li>
              <li>Visiting researcher at FREEDM Systems Center, NC State University, USA.</li>
              <li>Experience with Altium, Eagle, Xilinx ISE, Spartan FPGA controllers, TI-DSP, MSP430, MATLAB, Simulink, PSIM, LabVIEW, and dSPACE tools.</li>
            </ul>`
        },
        {
          kicker: "Experience",
        ...
        },
        {
          ...
          body: `
            <div class="contact-panel">
              ...
              <a href="mailto:doggaravi19@gmail.com">doggaravi19@gmail.com</a>
              <a href="tel:+919381694994">+91 93816 94994</a>
